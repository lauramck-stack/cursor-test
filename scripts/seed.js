// Seed script for the roadmap app
// This script populates the application with sample data
...
function seedApplication() {
  ...
  try {
    // For now, we'll just log the data since this runs in Node.js
    // In a real app, this would typically go to a database
    console.log('✅ Successfully prepared sample data:');
    ...
    console.log('');
    console.log('📁 Data structure created in:');
    console.log('   - src/data/sampleData.ts');
    console.log('   - src/types/roadmap.ts');
    console.log('');
    console.log('🚀 Your roadmap app is now ready with sample data!');
    console.log('💡 To use this data in your app, import from src/data/sampleData.ts');
