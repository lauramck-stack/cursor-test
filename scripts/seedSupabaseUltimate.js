...
async function seedDatabase() {
  try {
    console.log('🌱 Starting ultimate Supabase database seeding...');
    ...
    // 5. Create roadmap items (using correct status and effort values)
    ...
    const roadmapItems = [
      ...
      },
      {
        ...
        status: 'in-progress', // Using hyphen, not underscore
        priority: 'medium',
        effort: 'medium',
        team_id: createdTeams[0].id,
